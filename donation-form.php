        ...
        <div class="ui grid">
            ...
            <div class="twelve wide column">
                ...
                <form action="<?php $_PHP_SELF ?>" method="post" class="ui form">
                    ...
                    <h4 class="ui dividing header">Cheque and M-pesa</h4>
                    <div class="field">
                      <label>Cheque / M-pesa no.</label>
                      <input type="text" name="check" placeholder="Check / Mpesa no." required>
                    </div>
                    <div class="field">
